<template>
  <div class='default-layout'>
    ...
    <modal :show='modals.login' @close-modal="closeModal('login')">
      <h2 class='text-grey-darkest font-semibold text-center mb-6'>Bienvenido a Platzi Rooms</h2>
    ...
    <modal :show='modals.register' @close-modal="closeModal('register')">
      <h2 class='text-grey-darkest font-semibold text-center mb-6'>Registrese en Platzi Rooms</h2>
        ...
        <div class='mb-4'>
          ...
          <div class='form__field relative'>
            <input v-model='formRegister.password'
              class='input__field' type='password'
              placeholder='*********' />
          </div>
        </div>
        <div class='mb-4'>
          <button class='btn btn-primary mr-3 w-full'>Registrarse</button>
        </div>
      </form>
    </modal>
  </div>
